...
#git clone https://source.developers.google.com/p/blockchain-185216/r/blockchain-js /opt/app
git clone https://github.com/ltearno/blockchain-js.git /opt/app
...
[program:nodeapp]
directory=/opt/app/blockchain-js
command=npm start
autostart=true
autorestart=true
user=nodeapp
